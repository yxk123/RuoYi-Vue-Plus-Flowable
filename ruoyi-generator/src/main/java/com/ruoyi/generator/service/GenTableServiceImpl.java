...
public class GenTableServiceImpl implements IGenTableService {
    ...
    @Override
    public TableDataInfo<GenTable> selectPageDbList(GenTable genTable, PageQuery pageQuery) {
        Page<GenTable> page = baseMapper.selectPageDbList(pageQuery.build(), genTable);
        return TableDataInfo.build(page);
    }
