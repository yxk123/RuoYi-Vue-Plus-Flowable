    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="font-size: 30px; float: right">
            <el-tooltip effect="dark" content="gitee登陆" placement="top">
                <svg-icon icon-class="gitee" class="icon" @click="handleSocialLogin('gitee')" />
            </el-tooltip>
            <el-tooltip effect="dark" content="github登陆" placement="top">
                <svg-icon icon-class="github" class="icon" @click="handleSocialLogin('github')" />
            </el-tooltip>
            <el-tooltip effect="dark" content="QQ登陆" placement="top">
                <svg-icon icon-class="qq" class="icon" @click="handleSocialLogin('qq')" />
            </el-tooltip>
            <el-tooltip effect="dark" content="微信登陆" placement="top">
...
<script>
import { getCodeImg,renderAuth } from "@/api/login";
