    ...
    <div class="app-container">
        <div v-if="dataViewVisible">
            ...
            <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
                ...
                <el-table-column  align="center" prop="suspensionState" label="流程状态" width="160">
                ...
                <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
                  <template slot-scope="scope">
                    <el-button size="mini" icon="el-icon-sort" v-if="scope.row.isClaim===false && scope.row.parentTaskId == null" type="text"
                    @click="clickClaim(scope.row)">签收 &nbsp;</el-button>
                    <el-button size="mini" icon="el-icon-sort" v-if="scope.row.isClaim===true && scope.row.parentTaskId == null" type="text"
