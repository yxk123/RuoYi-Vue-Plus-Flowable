<template>
    <div class="app-container">
         <el-form :model="queryParams" size="small" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
        ...
        <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
            ...
            <el-table-column  align="center" prop="suspensionState" label="流程状态" width="80">
        ...
        <el-dialog title="审批记录" :visible.sync="visible" v-if="visible" width="80%" :close-on-click-modal="false">
            <div class="historyContainer">
              <history :processInstanceId="processInstanceId" :editMessage="true" :editBackNode="true"></history>
            </div>
        </el-dialog>
