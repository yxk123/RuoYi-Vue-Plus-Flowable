    ...
    <div class="container" v-loading="loading">
      <el-form style="height:inherit" ref="form" size="small" label-position="left" :model="form">
          ...
          <el-row v-if="form.index === 1">
            ...
            <el-col class="line" :span="8">
                <el-form-item label="是否能退回到当前节点" prop="isBack">
          ...
          <el-row v-if="form.index === 1">
            ...
            <el-col class="line" :span="8">
              <el-form-item label="当前节点是否显示退回" prop="showBack">
                <el-switch v-model="form.showBack"></el-switch>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="20">
              <el-form-item label-width="100px" label="节点任务" prop="task">
                <el-popover
                  ...
                  <el-alert style="margin:10px 0px 10px 0" title="说明：当前任务节点完成前或完成后执行" type="warning" :closable="false"></el-alert>
            ...
            <el-col :span="20">
              <el-form-item label-width="100px" label="审批人员" prop="assignee">
                <el-input readonly v-model="form.assignee" placeholder="审批人员">
                  <el-button type="primary" slot="append" @click="openSelect">{{ btnText }}</el-button>
...
import  ProcessRule from "@/views/workflow/definition/components/processBpmnSetting/processRule";
import  processFieldSetting from "@/views/workflow/definition/components/processBpmnSetting/processFieldSetting";
