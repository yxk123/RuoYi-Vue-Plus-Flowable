...
<br>
[![RuoYi-Vue-Plus-Flowable](https://img.shields.io/badge/RuoYi_Vue_Plus_Flowable-4.8.0-success.svg)](https://gitee.com/sgs98/RuoYi-Vue-Plus-Flowable)
[![Spring Boot](https://img.shields.io/badge/Spring%20Boot-2.7-blue.svg)]()
[![JDK-8+](https://img.shields.io/badge/JDK-8-green.svg)]()
[![JDK-11](https://img.shields.io/badge/JDK-11-green.svg)]()

>本项目在[RuoYi-Vue-Plus-Flowable](RuoYi-Vue-Plus-Flowable)基础上集成GmSSL。集成国密加解密插件，实现等保测评2.0标准对数据加密要求。  
本项目保留原有项目RuoYi-Vue-Plus-Flowable的所有功能，原项目RuoYi-Vue-Plus 是重写 RuoYi-Vue 针对 `分布式集群` 场景全方位升级(不兼容原框架)。
                                                                       
国密算法应用场景
|功能|算法|描述|
|-|-|-|
|系统日志|SM2|对系统登录日志和操作日志做数据签名保护数据完整性|
|系统登录|SM3|对用户登录密码进行散列并保存摘要到数据库|
|敏感数据加密|SM4|对手机号码等敏感数据进行加密后保存到数据库，查询时进行解密|
